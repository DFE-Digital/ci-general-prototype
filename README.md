# DfE RSD Continuous Improvement prototypes
...
## Installation
1. Clone this repository to a local directory folder: git clone git@github.com:DFE-Digital/ci-general-prototype.git
2. Navigate to the new directory `ci-general-prototype` and open the terminal or command line
